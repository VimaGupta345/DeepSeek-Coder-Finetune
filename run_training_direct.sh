...
# Configuration
SCRIPT_NAME="finetune_full_deepseekcoder.py"
DATA_PATH="data/rust_instruct_format2.jsonl"
OUTPUT_PATH="../../../scratch/shared_dir/finetuned_models/output/full_training_rust_$(date +%Y%m%d_%H%M%S)"
...
torchrun \
    ...
    --max_steps 1500 \
    --report_to "wandb" \
    --run_name "h200-deepseek-full-$(date +%Y%m%d_%H%M%S)" \
